...
// Incoming items routes - Diperbaiki sesuai requirement
...
$routes->get('/incoming-items/view/(:num)', 'IncomingItems::view/$1');
$routes->get('/incoming-items/edit/(:num)', 'IncomingItems::edit/$1');
$routes->post('/incoming-items/update/(:num)', 'IncomingItems::update/$1');
$routes->get('/incoming-items/delete/(:num)', 'IncomingItems::delete/$1');
$routes->post('/incoming-items/delete/(:num)', 'IncomingItems::delete/$1'); // TAMBAHAN INI
$routes->get('/incoming-items/receipt/(:num)', 'IncomingItems::receipt/$1');
$routes->get('/incoming-items/history/(:num)', 'IncomingItems::history/$1');
$routes->get('/incoming-items/receive-from-purchase/(:num)', 'IncomingItems::receiveFromPurchase/$1');
$routes->post('/incoming-items/bulk-receive', 'IncomingItems::bulkReceive');
...
$routes->get('/incoming/edit/(:num)', 'IncomingItems::edit/$1');
$routes->post('/incoming/update/(:num)', 'IncomingItems::update/$1');
$routes->get('/incoming/delete/(:num)', 'IncomingItems::delete/$1');
$routes->post('/incoming/delete/(:num)', 'IncomingItems::delete/$1'); // TAMBAHAN INI JUGA
...
$routes->get('/outgoing-items/edit/(:num)', 'OutgoingItems::edit/$1');
$routes->post('/outgoing-items/update/(:num)', 'OutgoingItems::update/$1');
$routes->get('/outgoing-items/delete/(:num)', 'OutgoingItems::delete/$1');
$routes->post('/outgoing-items/delete/(:num)', 'OutgoingItems::delete/$1'); // TAMBAHAN INI JUGA
...
$routes->get('/outgoing/edit/(:num)', 'OutgoingItems::edit/$1');
$routes->post('/outgoing/update/(:num)', 'OutgoingItems::update/$1');
$routes->get('/outgoing/delete/(:num)', 'OutgoingItems::delete/$1');
$routes->post('/outgoing/delete/(:num)', 'OutgoingItems::delete/$1'); // TAMBAHAN INI JUGA
