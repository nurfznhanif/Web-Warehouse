...
<body class="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-600 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white mb-2">Warehouse MS</h1>
            <p class="text-blue-200">Sistem Manajemen Gudang</p>
        </div>
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-mono bg-white px-2 py-1 rounded">operator / password</span>
                    </div>
                </div>
            </div>
        </div>
