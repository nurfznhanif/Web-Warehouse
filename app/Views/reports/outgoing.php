...
<div class="bg-white rounded-lg shadow-sm p-6 mb-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Filter dan lihat laporan barang keluar berdasarkan rentang tanggal</p>
        </div>
...
<!-- Filter Section -->
<div class="bg-white rounded-lg shadow-sm p-6 mb-6">
    <form method="GET" action="<?= base_url('/reports/outgoing') ?>" class="space-y-4">
...
<?php if ($start_date && $end_date): ?>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-600"><?= number_format($summary['total_transactions']) ?></p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Data Barang Keluar</h3>
                <?php if (!empty($outgoing_items)): ?>
                    <button onclick="exportToCSV()" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm transition-colors">
        ...
        <?php if (!empty($outgoing_items)): ?>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200" id="outgoing-table">
        ...
        <?php else: ?>
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Tidak ada transaksi barang keluar pada periode yang dipilih.</p>
            </div>
        <?php endif; ?>
    </div>
...
<?php else: ?>
    ...
    <div class="bg-white rounded-lg shadow-sm p-12 text-center">
        ...
        <p class="text-gray-500">Silakan pilih tanggal mulai dan tanggal selesai untuk melihat laporan barang keluar.</p>
    </div>
<?php endif; ?>
...
<script>
    ...
    function exportToCSV() {
        ...
        if (link.download !== undefined) {
            ...
            link.setAttribute('download', `laporan-barang-keluar-${new Date().toISOString().split('T')[0]}.csv`);
